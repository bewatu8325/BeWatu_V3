...
const MainApp: React.FC = () => {
  ...
  const handleAuthenticationSuccess = (user: User) => {
    setAuthState('authenticated');
    if(user.isRecruiter && activeProfile === 'recruiter') {
        const trialEndDate = localStorage.getItem('recruiterTrialEndDate');
        if (!trialEndDate) {
  ...
  const handleLoginSuccess = (email: string, isRecruiterLogin: boolean) => {
    ...
    handleAuthenticationSuccess(loggedInUser);
  };
  ...
  const handleRegisterSuccess = (name: string, email: string, isRecruiter: boolean, stripeCustomerId?: string) => {
    ...
    handleAuthenticationSuccess(newUser);
  }
  ...
  const renderAuthFlow = () => {
    switch(authState) {
        case 'connect':
            return <ConnectPage onNavigateBack={() => setAuthState('landing')} />;
        case 'about':
            return <AboutPage onNavigateBack={() => setAuthState('landing')} onNavigateToConnect={handleNavigateToConnect} />;
        case 'login':
            return <LoginPage onLoginSuccess={handleLoginSuccess} onNavigateToRegister={() => setAuthState('register')} onNavigateToForgotPassword={() => setAuthState('forgot_password')} onNavigateToConnect={handleNavigateToConnect} onNavigateToLanding={handleNavigateToLanding} />;
        case 'register':
            return <RegistrationPage onRegisterSuccess={handleRegisterSuccess} onNavigateToLogin={() => setAuthState('login')} onNavigateToConnect={handleNavigateToConnect} onNavigateToLanding={handleNavigateToLanding} />;
        case 'forgot_password':
            return <ForgotPasswordPage onResetRequest={() => setAuthState('login')} onNavigateToLogin={() => setAuthState('login')} onNavigateToConnect={handleNavigateToConnect} onNavigateToLanding={handleNavigateToLanding} />;
        case 'landing':
        default:
