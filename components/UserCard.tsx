...
const UserCard: React.FC<UserCardProps> = ({
  ...
  const connectStyles = isConnected
    ? 'flex-grow bg-slate-600 text-slate-300 font-semibold px-4 py-1.5 rounded-full cursor-default'
    : isPending
    ? 'flex-grow bg-slate-700 text-cyan-400 border border-cyan-500/50 font-semibold px-4 py-1.5 rounded-full cursor-default'
    : 'flex-grow bg-cyan-500 text-slate-900 font-semibold px-4 py-1.5 rounded-full hover:bg-cyan-400 transition-colors';
